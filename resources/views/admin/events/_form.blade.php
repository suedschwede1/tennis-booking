...
@if(!empty($popup_mode))
    <div class="space-y-4">
        <div class="space-y-1">
            <label class="block text-[13px] font-medium text-[#151515]" for="ef-name">Name</label>
            <input id="ef-name" type="text" name="name" value="{{ old('name', $name ?? '') }}" required placeholder="Bezeichnung der Veranstaltung" class="w-full h-9 rounded-[6px] border border-[#c7c7c7] bg-white px-3 text-sm text-[#151515] outline-none placeholder:text-[#b8b8b8] focus:border-[#151515]">
        </div>

        <div class="space-y-1">
            <label class="block text-[13px] font-medium text-[#151515]" for="ef-description">Beschreibung</label>
        ...
        <div>
            ...
            <div class="grid grid-cols-4 gap-3">
                <div class="space-y-1">
                    <label class="block text-[13px] font-medium text-[#151515]">Datum (Beginn)</label>
                ...
                <div class="space-y-1">
                    <label class="block text-[13px] font-medium text-[#151515]">Zeit (Beginn)</label>
                ...
                <div class="space-y-1">
                    <label class="block text-[13px] font-medium text-[#151515]">Datum (Ende)</label>
                ...
                <div class="space-y-1">
                    <label class="block text-[13px] font-medium text-[#151515]">Zeit (Ende)</label>
            ...
            <div class="mt-3 grid grid-cols-2 gap-3">
                <div class="space-y-1">
                    <label class="block text-[13px] font-medium text-[#151515]">Platz</label>
                ...
                <div class="space-y-1">
                    <label class="block text-[13px] font-medium text-[#151515]">Kapazität</label>
                    ...
                    <p class="text-xs text-[#6a6e73]">0 = unbegrenzt</p>
                </div>
            </div>
        </div>

        <div class="space-y-1">
            <label class="block text-[13px] font-medium text-[#151515]" for="ef-notes">Notizen</label>
...
<div class="ui-form-shell">
    ...
    <div class="ui-form-divider">
        <p class="ui-section-label !mb-0">Zeitraum</p>
        <div class="ui-grid-4">
        <div class="ui-field">
    ...
    <div class="ui-form-divider">
        <p class="ui-section-label !mb-0">Notizen</p>
        <div class="ui-field">
